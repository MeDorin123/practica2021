            ...
            <div class="modal-body">
                    ...
                    <div id="boardEditName"></div>
                        ...
                        <input type="hidden" name="id" id="userID" value="" />
                         ...
                         <div class="PentruSelectAsignariTask" class="form-control" >
                         <select class="custom-select rounded-0"  id="AssignmentEditBoard" value='' >
                             @foreach($users as $selectUser)
                     <option selected="selected" >{{$selectUser->name}}</option>
